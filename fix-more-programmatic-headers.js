...
// List of additional programmatic SEO pages to fix
const programmaticPages = [
    'commercial-truck-insurance-leads-small-texas-towns.html',
    'motorcycle-insurance-marketing-rural-alabama.html',
    'crop-insurance-marketing-rural-iowa.html'
];
...
console.log('\n✨ All additional programmatic pages have been updated with the homepage header!');